...
#define  DEL  '#'
#define  SR   "r" // Single Reading
#define  CR   "c" // Contineous Reading
#define  DR   "e" // Disable Reading
#define  OP   "%" //Oxygen Percentage Sign
#define  ETX  '\r' //End of Frame
#define  NTX  '\n' //End of Frame
...
void loop(){
  ...
  delay(5000); // 15-seconds required for radio reassociation 
  char str[80];
  ...
  //delay(1000);
  String tx =  DEL + sal + "," + oxygen + "," + ph + DEL + ETX + NTX; 
