...
void loop() {
    ...
    lcd.print("Alt= ");lcd.print(altitude_ft);
    lcd.print(" ft"); 
    delay(5000); 
    lcd.clear(); 
    lcd.print("Alt= "); lcd.print(FT_TO_M(altitude_ft));
    lcd.print(" m");
    delay(5000); 
    lcd.clear(); 
    lcd.print("PRS= "); lcd.print(KPA_TO_INHG(pressure_pKa), 2);
    lcd.print(" Hg");
    delay(5000); 
    lcd.clear(); 
    lcd.print("PRS= "); lcd.print(KPA_TO_MMHG(pressure_pKa), 0);
    lcd.print(" mm Hg");
    delay(5000); 
    lcd.clear(); 
    lcd.print("PRS= "); lcd.print(KPA_TO_PSIA(pressure_pKa), 2);
    lcd.print(" psia");
    delay(5000); 
    lcd.clear(); 
    //lcd.print(KPA_TO_KGCM2(pressure_pKa), 3);
    ///lcd.print(" kg/cm2 | ");
    lcd.print("PRS= ");lcd.print(pressure_pKa, 1);
    lcd.print(" kPa");
    delay(5000); 
    lcd.clear(); 
    // At a res of -5.35 counts/°C, digits lower than 0.1°C are not significant
    lcd.print("Temp= "); lcd.print(temperature_c, 1);
    lcd.print(" C");
    delay(5000); 
    lcd.clear(); 
    lcd.print("Temp= "); lcd.print(DEGC_TO_DEGF(temperature_c), 1);
    lcd.print(" F");
    delay(5000); 
    lcd.clear(); 
