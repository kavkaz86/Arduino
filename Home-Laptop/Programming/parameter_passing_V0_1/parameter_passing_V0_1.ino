...
void loop(){
  ...
  TempValue = map(analogRead(A3), 0,1023, 0, 5); 
  TempValue =(298*TempValue/2.95) - 273.15;
  Serial << "T" << TempValue << endl;
  delay(2000);
  
  HumdValue = map(analogRead(A4), 0,1023, 0, 5); 
  HumdValue = (HumdValue - 0.958 ) / 0.0307;
  Serial << "H" << HumdValue << endl; 
  delay(2000);
  
  AirValue = analogRead(A1); 
  AirValue = map(analogRead(A1), 0, 1023, 0, 5);
  Serial << "A" << AirValue << endl;
  delay(2000);
  
  MethValue = analogRead(A0);
  MethValue = map(analogRead(A0), 0,1023, 0, 5); 
  Serial << "M" << MethValue << endl;
  delay(2000);
  
  LpgValue = analogRead(A2);
  LpgValue = map(analogRead(A2), 0,1023, 0, 5); 
  Serial << "L" << LpgValue << endl;
  delay(2000);
  ...
  Serial << "P" << pressure_pKa << endl; 
  delay(2000);
  Serial << "m" << KPA_TO_INHG(pressure_pKa) << endl; 
  delay(2000);
  Serial << "h" << KPA_TO_MMHG(pressure_pKa) << endl;
  delay(2000);
  Serial << "p" << KPA_TO_PSIA(pressure_pKa) << endl;
  delay(2000);
  Serial << "t" << temperature_c << endl;
  delay(2000);
  Serial << "a" << FT_TO_M(altitude_ft) << endl;
  delay(2000);
