...
int pirPin = 2; //Interrupt Pin for PIR Sensor         
int vibPin = 3; //Interrupt Pin for Vibration Sensor
int commPin = 19; //Interrupt Pin for Rx Data
...
void setup()
{
  ...
  attachInterrupt(1, vibWakeUp, FALLING);      

  attachInterrupt(4, commWakeUp, FALLING);  
}
