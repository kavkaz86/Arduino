...
/*
String  format_payload(const float data[], int _sizeData) {
...
/*int tx_frame(const char n_id, const int f_id, const int Smap, const float _data[]) {
  
  String payload=format_payload(_data, sizeof(_data));
   
  switch (f_id) {

    case  rep_frame:
      
      Serial << f_id << "," << n_id << "," << payload  <<  endl;
      break;

    case  ir_frame:
      
      Serial << f_id << "," << n_id << "," << Smap << "," << payload <<  endl;
      break;
    ...
    case  diag_frame:
      Serial << f_id << "," << n_id << "," << SENS_REQ << endl;
      break;
